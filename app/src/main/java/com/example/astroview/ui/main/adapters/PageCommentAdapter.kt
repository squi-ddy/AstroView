...
class PageCommentAdapter(
    private val commentList: Collection<PageReview>
) : RecyclerView.Adapter<PageCommentAdapter.ViewHolder>() {
    ...
    class ViewHolder(private val binding: CardReviewBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bindItems(review: PageReview) {
